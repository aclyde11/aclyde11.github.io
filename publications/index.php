...
<head>
<meta charset="utf-8">
<title>[ Clyde | All Publications ]</title>
...
<section id="tree" style="margin-top:50px">
    <div class="container">
        <a href="../index.html">Clyde</a> > All Publications
    </div>
</section>
...
<section id="home">
    ...
    <br>
    <h1 align="CENTER">All Publications of Austin Clyde</h1>
    <br>
<?php
    ...
    $article = array("title", "author", "journal", "series", "location", "publisher", "volume", "number", "pages", "doi",  "year", "award");
    $book = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages", "doi",  "year");
    $booklet = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages", "doi",  "year");
    $conference = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages", "doi",  "year", "award");
    $inbook = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages",  "doi", "year");
    $incollection = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "chapter", "pages", "doi",  "year", "award");
    $inproceedings = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "chapter", "pages",  "doi", "year", "award");
    $manual = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages",  "doi");
    $mastersthesis = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages",  "isbn");
    $misc = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages",  "doi", "isbn");
    $proceedings = array("booktitle", "series", "author", "location", "publisher", "volume", "pages",  "doi", "isbn", "award");
    $techreport = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages", "doi",  "year");
    $preprint = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages",  "doi","year");
    $other = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "pages", "doi", "year");
    ...
    $sortby = array('journal', 'conference', 'book', 'editorial', 'theses', 'preprint');
    $sortbyTitle = array('Journals and Magazines', 'Conference Proceedings', 'Book Chapters', 'Editorials','Theses', 'Preprints');
